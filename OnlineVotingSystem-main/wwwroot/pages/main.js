    ...
    if (registerForm) {
        registerForm.addEventListener("submit", async function (event) {
            ...
            try {
                ...
                const registerResponse = await fetch("https://localhost:7044/api/auth/register", {
                    method: "POST",
                ...
                const captchaZipResponse = await fetch(`https://localhost:7044/api/auth/generateCaptcha?email=${email}`);
